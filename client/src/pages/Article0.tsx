...
function Article0Content() {
  return (
    <div className="space-y-8" style={{ fontFamily: "'IBM Plex Serif', serif" }}>
      ...
      {/* Part II */}
      <div className="mb-12">
        <h2 className="text-2xl font-bold text-foreground mb-8" style={{ fontFamily: "'Space Grotesk', sans-serif" }}>Part II: The Legal and Philosophical Crisis</h2>

        <div className="mb-10">
          <h3 className="text-xl font-semibold text-foreground mb-5" style={{ fontFamily: "'Space Grotesk', sans-serif" }}>2.1 The Authorship Problem</h3>
          <p>
        ...
        <div className="mb-10">
          <h3 className="text-xl font-semibold text-foreground mb-5" style={{ fontFamily: "'Space Grotesk', sans-serif" }}>2.2 The Post-Data-Hoarding Economy</h3>
          <p>
